...
Project.create(title: "Hip Hop e Vida", description: "Estamos desenvolvendo um projeto para ajudar pessoas que estão se sentindo sozinhas, com o Hip Hop podemos mais!", goal: 320.00, start_date: Date.current, endline: Date.current + 20.days, user_id: user1.id, image: Rack::Test::UploadedFile.new("app/assets/images/seed2.jpg"))
Project.create(title: "Música Todo Dia", description: "Projeto para ajudar crianças a terem aulas de música, e ter contato com a música todos os dias.", goal: 410.00, start_date: Date.current, endline: Date.current + 20.days, user_id: user2.id, image: Rack::Test::UploadedFile.new("app/assets/images/seed3.jpg"))
